      ...
      <section className="px-6 md:px-16 lg:px-24 py-20">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mb-4 leading-relaxed">
            Applications for the Singapore 2026 cohort are now closed. If you&apos;re interested in future cohorts or
            would like to be notified about upcoming programs, please fill out the form below.
          </p>
