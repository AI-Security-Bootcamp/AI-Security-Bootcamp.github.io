  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 px-4 py-8 md:px-8 lg:px-16">
      ...
      <header className="max-w-4xl mx-auto text-center mb-16">
        ...
        <div className="text-lg md:text-xl text-gray-600 mb-4 flex flex-wrap justify-center gap-2 md:gap-4">
      ...
      <main className="max-w-4xl mx-auto space-y-20">
        ...
        <section>
          <h2 className="text-4xl font-bold mb-8 text-center">Who was this for?</h2>
