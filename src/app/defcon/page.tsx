...
export default function DefconVisit() {
      ...
      <section className="px-6 md:px-16 lg:px-24 py-20">
        <div className="max-w-3xl">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-base md:text-lg leading-relaxed mb-8 max-w-2xl">
            If you&apos;re in town and would like to drop by, say hi, and meet the cohort, fill in
            the form below with the dates you&apos;d like to visit.
          </p>
